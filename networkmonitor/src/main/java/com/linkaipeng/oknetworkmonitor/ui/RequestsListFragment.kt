...
class RequestsListFragment : Fragment() {
    ...
    var networkFeedAdapter: NetworkFeedAdapter? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        networkFeedAdapter = NetworkFeedAdapter(activity)
        requestsRecyclerView.adapter = networkFeedAdapter
    }

    fun clean() {
        networkFeedAdapter?.clean()
    }
