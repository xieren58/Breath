...
class Utils {
    ...
    companion object {
        ...
        fun transformToTraceDetail(eventsTimeMap: MutableMap<String, Long>): LinkedHashMap<String, Long> {
            ...
            traceDetailList[NetworkTraceModel.TRACE_NAME_TOTAL] =
                getEventCostTime(eventsTimeMap, NetworkTraceModel.CALL_START, NetworkTraceModel.CALL_END)
            traceDetailList[NetworkTraceModel.TRACE_NAME_DNS] =
                getEventCostTime(eventsTimeMap, NetworkTraceModel.DNS_START, NetworkTraceModel.DNS_END)
            traceDetailList[NetworkTraceModel.TRACE_NAME_SECURE_CONNECT] =
                getEventCostTime(eventsTimeMap, NetworkTraceModel.SECURE_CONNECT_START, NetworkTraceModel.SECURE_CONNECT_END)
            traceDetailList[NetworkTraceModel.TRACE_NAME_CONNECT] =
                getEventCostTime(eventsTimeMap, NetworkTraceModel.CONNECT_START, NetworkTraceModel.CONNECT_END)
            traceDetailList[NetworkTraceModel.TRACE_NAME_REQUEST_HEADERS] =
                getEventCostTime(eventsTimeMap, NetworkTraceModel.REQUEST_HEADERS_START, NetworkTraceModel.REQUEST_HEADERS_END)
            traceDetailList[NetworkTraceModel.TRACE_NAME_REQUEST_BODY] =
                getEventCostTime(eventsTimeMap, NetworkTraceModel.REQUEST_BODY_START, NetworkTraceModel.REQUEST_BODY_END)
            traceDetailList[NetworkTraceModel.TRACE_NAME_RESPONSE_HEADERS] =
                getEventCostTime(eventsTimeMap, NetworkTraceModel.RESPONSE_HEADERS_START, NetworkTraceModel.RESPONSE_HEADERS_END)
            traceDetailList[NetworkTraceModel.TRACE_NAME_RESPONSE_BODY] =
                getEventCostTime(eventsTimeMap, NetworkTraceModel.RESPONSE_BODY_START, NetworkTraceModel.RESPONSE_BODY_END)
